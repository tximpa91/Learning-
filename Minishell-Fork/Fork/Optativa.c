...
int main ()
{
    ...
    tree_collect();
     ...
     if ((pid = fork()) == 0) { // de un padre sacar un padre y un hijo punto y raya
        ...
        if ((pid = fork()) == 0) {
            tree_start ("task_2_1_2 ");
            tree_collect(); }
        else { if((pid=fork())==0){
            tree_start("task_2_1_3");
            
        }else{
        if((pid=fork())==0){
            tree_start("task_2_1_1");
            if ((pid = fork()) == 0) {
            tree_start ("task_2_1_1_1 ");
            tree_collect(); }
        else { if((pid=fork())==0){
            tree_start("task_2_1_1_2");
    ...
    tree_collect(); }
     ...
     if ((pid = fork()) == 0) { // de un padre sacar un padre y un hijo punto y raya
        ...
        if ((pid = fork()) == 0) {
            ...
            tree_start("task_1_1_1");
            
           if ((pid = fork()) == 0) {
            tree_start ("task_1_1_1_1 ");
            tree_collect(); }
        else { if((pid=fork())==0){
            tree_start("task_1_1_1_2");
            
            
         
        }else{
        if((pid=fork())==0){
            tree_start("task_1_1_1_3");
